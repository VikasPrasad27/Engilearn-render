...
function Hack() {
  return (
    <div 
    className="relative h-[90vh] flex flex-col items-center justify-center text-center bg-cover bg-slate-100 bg-center"
  ...
  >
    ...
    <div className='relative text-white'>
      <h1 className=" mt-6 text-xl sm:text-5xl font-bold">SOLVE YOUR DOUBTS & DISCUSS</h1>
